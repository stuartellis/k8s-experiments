...
provider "kubernetes" {
  host                   = module.eks_cluster_0020.cluster_endpoint
  cluster_ca_certificate = base64decode(module.eks_cluster_0020.cluster_certificate_authority_data)
  token                  = data.aws_eks_cluster_auth.cluster_0020.token
}
